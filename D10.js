...
console.log(isThisAnEmail("jack.black@gmail.com")); // Output: true
console.log(isThisAnEmail("john.black@.gmail.com")); // Output: false
...
function isTodayMyBirthday() {
  const today = new Date();
  const myBirthday = new Date(2000, 15, 7);
...
function addListItem(myList, text) {
